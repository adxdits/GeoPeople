...
class ClapDetector(private val context: Context) {
    ...
    companion object {
        ...
        private const val CLAP_THRESHOLD = 12000      // tuned for phone mics that compress peaks
        private const val SPIKE_RATIO = 3f            // must still stand out clearly from ambient noise
        private const val MIN_CLAP_INTERVAL_MS = 450L
        private const val NOISE_SMOOTHING = 0.08f
        private const val MIN_NOISE_FLOOR = 1200f     // never let floor collapse to 0
    }
