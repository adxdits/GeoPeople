...
import com.example.mini_game.model.Platform
import com.example.mini_game.model.PlatformType
import com.example.mini_game.model.Pokeball
...
class GameEngine {
    ...
    private fun checkCollision(ball: Pokeball, platform: Platform): Boolean {
        ...
        return ballBottom >= platform.y &&
                ballBottom <= platform.y + platform.height + ball.vy * 0.05f &&
    ...
    private fun handleBounce(platform: Platform) {
        ...
        pokeball.y = platform.y - pokeball.radius + 14f  // overlap so ball visually sits on grass
    }
    ...
    private fun generateInitialPlatforms() {
        ...
        // Start the ball sitting on the floor
        pokeball.y = floorY - pokeball.radius + 14f
        pokeball.vy = 0f
